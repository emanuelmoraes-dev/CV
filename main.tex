...
% right side %
{
    \csection{EXPERIÊNCIA}{\small
        \begin{itemize}
            \item \frcontent{\href{https://www.pathfind.com.br/}{Pathfind}}{Desenvolvimento de aplicações para otimizações nos resultados de vendas, roteamento e entregas.}{\textbf{Back-end:} Java (String framework)}{2021-atualmente}
        \end{itemize}
    }
